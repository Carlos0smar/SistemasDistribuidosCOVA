...
public class ClienteMultiHilo1 {
...
//                showTasks(dis);
    ...
    public static void addTask(DataOutputStream dos) throws IOException {
        Scanner scn = new Scanner(System.in);
    ...
    public static void deleteTask(DataOutputStream dos) throws IOException {
        Scanner scn = new Scanner(System.in);
